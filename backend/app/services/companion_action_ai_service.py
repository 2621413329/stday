...
- prop: none|workbook|exam_paper|ball|badminton_racket|game_controller|running_shoes|friends|chat_bubbles|heart|home|music|stars|umbrella|trophy 之一（情境配饰，生成后持久保留）
